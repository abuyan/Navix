...
export default function WeeklyPageClient({ posts, viewsMap, panels }: WeeklyPageClientProps) {
        ...
        <>
            ...
            <div className={`flex-1 flex flex-col min-w-0 transition-all duration-300 ${sidebarCollapsed ? 'md:ml-[72px]' : 'md:ml-64'}`}>
                <TopNav
                    ...
                    panels={panels}
                    activePanelId="weekly"
                />

                {/* 主内容区 - Medium 风格三栏布局 */}
                <div style={{ backgroundColor: 'var(--color-bg-primary)' }} className="pt-16">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">

                            {/* 中间主内容区 */}
                            <main className="lg:col-span-8 py-8 lg:px-16 h-full">
                            ...
                            {/* 右侧热门推荐栏 */}
                            <aside className="hidden lg:block lg:col-span-4 lg:pl-8 lg:border-l lg:border-[var(--color-border)] py-8 min-h-screen">
